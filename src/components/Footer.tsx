export default function Footer() {
  return (
    <footer className="bg-zinc-100 dark:bg-zinc-950 w-full py-12 px-8 mt-auto">
      ...
      <div className="mt-8 pt-6 border-t border-zinc-200 dark:border-zinc-800 max-w-screen-2xl mx-auto flex flex-col md:flex-row items-center md:items-start justify-between">
        <p className="font-body text-xs text-zinc-400 text-center md:text-left">
          © 2026 Ergohome. Ergonomía + Diseño.
          <span className="mx-2 hidden md:inline">|</span>
          <a className="hover:text-orange-500 transition-colors hover:underline decoration-orange-500 underline-offset-2 block md:inline mt-2 md:mt-0" href="/politica-de-privacidad">Política de Privacidad</a>
        </p>
      </div>
    </footer>
  );
